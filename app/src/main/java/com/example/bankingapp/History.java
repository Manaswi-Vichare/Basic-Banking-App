...
public class History extends AppCompatActivity {
    ...
    public void startAnimate(){
        newTrans.animate().translationXBy(800).setDuration(0).withEndAction(() -> newTrans.animate().translationXBy(-800).setDuration(500));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Transition> transHist = new ArrayList<>();
        SQLiteDatabase myDataBase = this.openOrCreateDatabase("customers", Context.MODE_PRIVATE,null);
        @SuppressLint("Recycle") Cursor c1 = myDataBase.rawQuery("SELECT * FROM transitions",null);
        ...
        TransactionAdapter adapter = new TransactionAdapter(this,R.layout.act_transaction,transHist);
